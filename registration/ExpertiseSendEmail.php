...
use PHPMailer\PHPMailer\Exception;
...

    {
        ...
        try {
            ...
            $mail->setFrom('sender@gmail.com', "Edutalk"); // sender's email and name
           ...
           // $headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n"; 
            ...
            $mail->Body    = 'Please Click This Button To Verify Your User Account: <a href=http://localhost/Edutalk/registration/ExpertiseVerify.php?code='.$code.'>Verify</a>' ;
