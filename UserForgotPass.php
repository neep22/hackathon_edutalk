...
if(isset($_POST['PasswordReset']))
{
  ...
  if($res != false)
  {
    ...
    $message = '<div>
     ...
     <br>
     <p><button class="btn btn-primary"><a href="http://localhost/Edutalk/UserPasswordReset.php?secret='.base64_encode($email).'">Reset Password</a></button></p>
     <br>
...
<div class="container">  
    ...
    <h3 text-align="center">Forgot Your Password...</h3><br/>
    <div class="box">
