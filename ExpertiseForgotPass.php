...
if(isset($_POST['PasswordReset']))
{
  ...
  $check_email = "select OwnerEmail from expertise where OwnerEmail='$OwnerEmail'";
  ...
  if($res != false)
  {
    ...
    $message = '<div>
     ...
     <br>
     <p><button class="btn btn-primary"><a href="http://localhost/Edutalk/ExpertisePasswordReset.php?secret='.base64_encode($OwnerEmail).'">Reset Password</a></button></p>
     <br>
