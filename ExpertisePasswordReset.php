...
if(isset($_POST['PasswordReset']))
{
  ...
  {
    $reset_password = "update expertise set OwnerPassword='$OwnerPassword' where OwnerEmail='$OwnerEmail'";
    $mainreset=$db->update($reset_password);
    if($mainreset)
    {
      $msg = 'Your password updated successfully <a href="expertlog.php">Click here</a> to login';
    }
    else
    {
...
if($_GET['secret'])
{
  ...
  $check_details = "select OwnerEmail from expertise where OwnerEmail='$OwnerEmail'";
